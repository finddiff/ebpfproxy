...
const (
	...
	// DialerSelectionPolicy_Select enables manual node selection via WebUI.
	DialerSelectionPolicy_Select DialerSelectionPolicy = "select"
	// DialerSelectionPolicy_SelectFallback prefers the selected node, falls back to min_moving_avg when unavailable.
	DialerSelectionPolicy_SelectFallback DialerSelectionPolicy = "select_fallback"
