...
//go:build (386 || amd64 || arm || arm64 || loong64 || mips64le || mipsle || ppc64le || riscv64 || wasm) && !dae_stub_ebpf
...
type bpfLanIngressParsed struct {
	_    structs.HostLayout
	Ethh struct {
		_        structs.HostLayout
		H_dest   [6]uint8
...
type bpfParseTransportCtx struct {
	_    structs.HostLayout
	Ethh struct {
		_        structs.HostLayout
		H_dest   [6]uint8
...
type bpfRouteCtx struct {
	...
	DomainWordIdx    uint32
	DomainWordBits   uint32
	DomainWordCached bool
	RouteState       uint8
	_                [2]byte
}
...
type bpfWanEgressParsed struct {
	_    structs.HostLayout
	Ethh struct {
		_        structs.HostLayout
		H_dest   [6]uint8
...
type bpfWanEgressRouteScratch struct {
	_       structs.HostLayout
	Flag    [8]uint32
	MacBe   [4]uint32
	IsWan   uint8
...
type bpfMapSpecs struct {
	...
	LanIngressScratchMap     *ebpf.MapSpec `ebpf:"lan_ingress_scratch_map"`
...
type bpfMaps struct {
	...
	LanIngressScratchMap     *ebpf.Map `ebpf:"lan_ingress_scratch_map"`
